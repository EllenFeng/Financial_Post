...
public class Company_all_info extends AppCompatActivity {
    ...
    public void yejigailan(){
        ...
        for(int i=2017;i>2001;i--) {
            ...
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
        ...
        database.close();
        ListAdapter adapter = new ArrayAdapter<String>(Company_all_info.this,R.layout.support_simple_spinner_dropdown_item,infodetail);
        gridView1.setAdapter(adapter);
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String a=infodetail.get(position);
                Toast.makeText(Company_all_info.this,a,Toast.LENGTH_SHORT).show();
            }
        });
    }
    public void zichanfuzhai(){
        ...
        Cursor cursor;
        for(int i=2017;i>2001;i--) {
            String table = "financial_data_zichanfuzhai_" + String.valueOf(i);
            String sql = "SELECT * FROM " + table + " WHERE \"代码\" LIKE '%" + ID + "%'";
            Log.i("sql", sql);
            cursor = database.rawQuery(sql, null);
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
                    String data = cursor.getString(cursor.getColumnIndex("总资产亿"));
                    infodetail.add(data == null ? "--" : data);
    ...
    public void lirun(){
        ...
        Cursor cursor;
        for(int i=2017;i>2001;i--) {
            String table = "financial_data_lirun_" + String.valueOf(i);
            String sql = "SELECT * FROM " + table + " WHERE \"代码\" LIKE '%" + ID + "%'";
            Log.i("sql", sql);
            cursor = database.rawQuery(sql, null);
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
                    String data = cursor.getString(cursor.getColumnIndex("营业收入亿"));
                    infodetail.add(data == null ? "--" : data);
    ...
    public void xianjinliuliang(){
        ...
        Cursor cursor;
        for(int i=2017;i>2001;i--) {
            String table = "financial_data_xianjinliuliang_" + String.valueOf(i);
            String sql = "SELECT * FROM " + table + " WHERE \"代码\" LIKE '%" + ID + "%'";
            Log.i("sql", sql);
            cursor = database.rawQuery(sql, null);
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
                    String data = cursor.getString(cursor.getColumnIndex("期末现金余额亿"));
                    infodetail.add(data == null ? "--" : data);
    ...
    public void chengzhangnengli(){
        ...
        Cursor cursor;
        for(int i=2017;i>2001;i--) {
            String table = "financial_data_chengzhangnengli_" + String.valueOf(i);
            String sql = "SELECT * FROM " + table + " WHERE \"代码\" LIKE '%" + ID + "%'";
            Log.i("sql", sql);
            cursor = database.rawQuery(sql, null);
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
                    String data = cursor.getString(cursor.getColumnIndex("主营业务收入增长率百分之"));
                    infodetail.add(data == null ? "--" : data);
    ...
    public void changzhainengli(){
        ...
        Cursor cursor;
        for(int i=2017;i>2001;i--) {
            String table = "financial_data_changzhainengli_" + String.valueOf(i);
            String sql = "SELECT * FROM " + table + " WHERE \"代码\" LIKE '%" + ID + "%'";
            Log.i("sql", sql);
            cursor = database.rawQuery(sql, null);
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
                    String data = cursor.getString(cursor.getColumnIndex("流动比率百分之"));
                    infodetail.add(data == null ? "--" : data);
    ...
    public void yinglinengli(){
        ...
        Cursor cursor;
        for(int i=2017;i>2001;i--) {
            String table = "financial_data_yinglinengli_" + String.valueOf(i);
            String sql = "SELECT * FROM " + table + " WHERE \"代码\" LIKE '%" + ID + "%'";
            Log.i("sql", sql);
            cursor = database.rawQuery(sql, null);
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
                    String data = cursor.getString(cursor.getColumnIndex("主营业务利润率百分之"));
                    infodetail.add(data == null ? "--" : data);
    ...
    public void yingyunnengli(){
        ...
        Cursor cursor;
        for(int i=2017;i>2001;i--) {
            String table = "financial_data_yingyunnengli_" + String.valueOf(i);
            String sql = "SELECT * FROM " + table + " WHERE \"代码\" LIKE '%" + ID + "%'";
            Log.i("sql", sql);
            cursor = database.rawQuery(sql, null);
            if (cursor == null) {
                ...
                while (cursor.moveToNext()) {
                    infodetail.add(String.valueOf(i));
                    infodetail.add(ID);
                    String data = cursor.getString(cursor.getColumnIndex("应收账款周转天数"));
                    infodetail.add(data == null ? "--" : data);
