...
public class City_info_fromDataCityList extends AppCompatActivity {
    ...
    public void yejigailan(){
        ...
        String sql="SELECT * FROM "+table+ " WHERE \"所在省市\" LIKE '%" + city+"%' order by \"年份\" DESC";
        ...
        cursor.close();
        database.close();
        ListAdapter adapter = new ArrayAdapter<String>(City_info_fromDataCityList.this,R.layout.support_simple_spinner_dropdown_item,infodetail);
        gridView1.setAdapter(adapter);
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String a=infodetail.get(position);
                Toast.makeText(City_info_fromDataCityList.this,a,Toast.LENGTH_SHORT).show();
            }
        });
    }
