...
public class StockNews extends AppCompatActivity implements Runnable{
...
//                    ListAdapter adapter = new ArrayAdapter<String>(InternationalNews.this,R.layout.support_simple_spinner_dropdown_item,retList);
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(StockNews.this, retList, // listItems数据源
...
//                String link2 = String.valueOf(link.getText());
                ...
                intent.setClass(StockNews.this,NewsContent.class);
    ...
    public void run() {//线程
        ...
        try {
            Document doc = Jsoup.connect("https://finance.sina.com.cn/stock/").get();
            Elements titles = doc.select(".tabs-contsWrap a");
            Elements titles1 = doc.select(".xhBlk b_gsgc a");
