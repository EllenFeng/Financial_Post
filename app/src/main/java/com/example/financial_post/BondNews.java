...
public class BondNews extends AppCompatActivity implements Runnable{
...
//                    ListAdapter adapter = new ArrayAdapter<String>(InternationalNews.this,R.layout.support_simple_spinner_dropdown_item,retList);
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(BondNews.this, retList, // listItems数据源
...
//                String link2 = String.valueOf(link.getText());
                ...
                intent.setClass(BondNews.this, NewsContent.class);
    ...
    public void run() {//线程
        ...
        try {
            Document doc = Jsoup.connect("http://finance.sina.com.cn/bond/").get();
            Elements titles = doc.select(".part01 .p_m a");
            Elements titles1 = doc.select(".part03 .p_m a");
