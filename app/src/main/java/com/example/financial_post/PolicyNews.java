...
public class PolicyNews extends AppCompatActivity implements Runnable{
...
//                    ListAdapter adapter = new ArrayAdapter<String>(InternationalNews.this,R.layout.support_simple_spinner_dropdown_item,retList);
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(PolicyNews.this, retList, // listItems数据源
...
//                String link2 = String.valueOf(link.getText());
                ...
                intent.setClass(PolicyNews.this,NewsContent.class);
